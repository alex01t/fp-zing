(README-debian-fp) What is Zing? ![Zulu Duke in a Box][1]
======================================
...
For a Zing 11 container, enter:
    ...
    docker run -it --rm azulfeaturepreview/zing-fp-debian:11 java -version

For a Zing 8 container, enter:

    docker run -it --rm azulfeaturepreview/zing-fp-debian:8 java -version
